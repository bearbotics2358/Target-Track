...
QT_MOC_LITERAL(3, 16, 10), // "onReceived"
QT_MOC_LITERAL(4, 27, 14), // "QMQTT::Message"
QT_MOC_LITERAL(5, 42, 7) // "message"

    },
    "Target\0updated\0\0onReceived\0QMQTT::Message\0"
    "message"
};
...
void Target::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onReceived((*reinterpret_cast< const QMQTT::Message(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Target::updated)) {
                *result = 0;
                return;
            }
        }
...
void *Target::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< Target*>(this));
